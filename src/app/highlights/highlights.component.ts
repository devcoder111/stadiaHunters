...
export class HighlightsComponent implements OnInit {
  ...
  meta_data = {
    title: 'Achievement Guides Highlights | Stadia Hunters',
    description: 'A list of the most recent achievement guides made by the community.',
  ...
  fetchGames(field:string = "created", query:string = "", reverse: boolean = true){
    this.page.init('highlight', field, { limit: 30, reverse: reverse, prepend: false })
  }
